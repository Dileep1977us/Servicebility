...
public class serviceabilityTestCore {
	...
	@FindBy(xpath=Configurations.IhaveGotIt)
	public WebElement IhaveGotIt;
	...
	public  void init() throws IOException, InterruptedException
	{
			...
			
		{
			...
			driver.get(Configurations.TestSiteUAT);//Change the URL for Env
